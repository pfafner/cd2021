...
<div id='id-material'/>
  ...
  **No.**  | **Fecha**    | **Tópicos**                                                         | **Actividades**
  ...
  03       | 18.01.2020   | Proba. condicional <br/> Variables aleatorias <br/> [Aula 03](aulas/aula03.pdf){:target="_blank"}  | **Obs.** Terminar de leer el material del aula03. <br/> Al final hay una tarea moral (voy a preguntar). <br/> [(M. Lefebvre) Basic Probability with Applications](http://library.lol/main/F3B9314CA31E0289D5FCD6EEDA01308A) 
