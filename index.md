...
<div id='id-material'/>
  ...
  **No.**  | **Fecha**    | **Tópicos**                                                         | **Actividades**
  ...
  04       | 21.01.2021   | Variables aleatorias <br/> [Aula 04](aulas/aula04.pdf){:target="_blank"} | <span style="color:red">some *red* text</span>.
  05       | 25.01.2021   | Variables aleatorias discretas. <br/> [Aula 05](aulas/aula05.pdf){:target="_blank"} |
  06       |              |                                                                     |
