...
<div id='id-material'/>
  ...
  **No.**  | **Fecha**    | **Tópicos**                                                         | **Actividades**
  ...
  28       | 26.04.2021   | Clasificadores lineales. Clasificador logístico. El perceptrón. <br/> [Aula 28](aulas/aula28.pdf){:target="_blank"} | Demo de clasificador lineal. <br/> [Demo](https://adrianstoll.com/ml/perceptron-learning-algorithm/){:target="_blank"}
