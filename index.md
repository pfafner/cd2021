...
<div id='id-material'/>
  ...
  **No.**  | **Fecha**    | **Tópicos**                                                         | **Actividades**
  ...
  02       | 14.01.2020   | Probabilidad <br/> [Aula 02](aulas/aula02.pdf){:target="_blank"}    | **Obs.** me falta corregir el problema del cumpleaños. <br/> [(K.-L. Chung) A Course in Probability Theory](http://library.lol/main/6B122D4F68618DB5F1893F0296CB2491){:target="_blank"} <vr/> [(M. Lefebvre) Basic Probability with Applications](http://library.lol/main/F3B9314CA31E0289D5FCD6EEDA01308A)
